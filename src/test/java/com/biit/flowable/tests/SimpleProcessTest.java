...
public class SimpleProcessTest extends AbstractTransactionalTestNGSpringContextTests {
    ...
    public void simpleProcessTest() {
        ...
        Assert.assertEquals(taskService.createTaskQuery().processInstanceId(processInstance.getId()).count(), 1);
    }
    ...
    public void fullTest() {
        ...
        Assert.assertEquals(taskService.createTaskQuery().taskAssignee(HOLIDAY_PROCESS_APPROVE_TASK_USER2).count(), 1);
        ...
        Assert.assertEquals(taskService.createTaskQuery().taskAssignee(HOLIDAY_PROCESS_APPROVE_TASK_USER2).count(), 0);
        ...
        Assert.assertEquals(taskService.createTaskQuery().taskAssignee(HOLIDAY_PROCESS_APPROVE_TASK_USER).count(), 1);
    ...
    public void listAllAvailableTasks() {
        ...
        // Not assigned yet!
        Assert.assertEquals(taskService.createTaskQuery().processInstanceId(holidayRequestId).list().get(0)
                .getAssignee(), null);
    }
    ...
    public void claimSecondTask() {
        ...
        Assert.assertEquals(sendRequestApproval.getName(), HOLIDAY_PROCESS_APPROVE_TASK_2_NAME);
